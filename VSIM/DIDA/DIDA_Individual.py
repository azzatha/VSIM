...
if (os.stat(fileName).st_size == 0):
    ...
    y.to_csv("./DIDA/GeneIDCount.txt", sep="\t")

    y2 = pd.read_csv('./DIDA/GeneIDCount.txt', sep="\t", header=None)
    ...
    FileWithAllinfo.to_csv("./IndvResults/FinalDi_"+str(fileName1), index = False, sep="\t")