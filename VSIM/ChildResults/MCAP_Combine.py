...
if (os.path.isdir('./ChildResults/mcap_'+path)):

    fileName = './ChildResults/mcap_'+path+'/MCAP_AllChild.vcf'
    if (os.stat(fileName).st_size == 0):
        ...
        t.to_csv("./ChildResults/temp.txt", sep='\t')

        mcap = pd.read_csv("./ChildResults/temp.txt", sep='\t')
        ...
        # print(mcap)
        mcap.to_csv("./ChildResults/FinalMCAP_"+path, index=False, sep="\t")
